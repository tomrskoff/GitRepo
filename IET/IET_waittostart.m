function [screens, screenNumber,  black,white, window, windowRect, screenXpixels, screenYpixels, xCenter, yCenter] = IET_waittostart(eqorcar)
...
DrawFormattedText(window, [WrapString('Choose the image that best matches the FACE of the top image.',35) '\n\n We will begin shortly.'], 'center', 'center', white);
Screen('Flip', window);
