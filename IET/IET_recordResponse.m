function [responseTime, response, rightorWrong, eventOffset]= IET_recordResponse(duration, answerSide, screenYpixels, screenXpixels, window, ISI, i, stimperblock);
...
while (GetSecs-startTime) < duration
    ...
    if keyIsDown
        ...
        if v==KbName('RightArrow')
            ...
            IET_square(response, screenYpixels, screenXpixels, window)
            break;
