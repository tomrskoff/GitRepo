function [face1, face2, face3] = EET_condition2(d, facenumber, sex, race, face_previous)
while 1
    idx=randi(facenumber); % Finds random face
    face1=d(idx).name;
    if face1(3)==sex && face1(4) == race && strcmp(face1(1:4), face_previous) == 0 % Make sure face is desired sex
        break;
    end
end
